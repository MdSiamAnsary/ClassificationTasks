...
# Bengali punctuations (including common Bengali marks)
...
rf_model = RandomForestClassifier(
    n_estimators=100,
    max_depth=10,
    max_features='sqrt',  # feature bagging: random subset of features
    bootstrap=True,       # bootstrap samples of data (bagging)
    random_state=42,
